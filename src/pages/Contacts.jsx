  ...
  return (
    ...
    >
      ...
      <div className="flex gap-4 pt-4">
        ...
        <button type="button" onClick={onCancel} className="px-8 py-4 border border-slate-200 dark:border-slate-800 rounded-2xl font-black text-[11px] tracking-[0.2em] uppercase text-slate-500 hover:bg-slate-50 dark:hover:bg-white/5 transition-all">
          CANCELAR
        </button>
      </div>
    </form>
...
export default function Contacts() {
  ...
  // ... (Efectos y lógica de fetch iguales)
  ...
  return (
    ...
    >
      <div className="max-w-5xl space-y-8 pb-12">
        ...
        <Card className="dark:bg-[#0d1426] dark:border-slate-800 p-8 shadow-2xl">
