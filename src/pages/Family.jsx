  ...
  return (
    <div className="max-w-md mx-auto mt-12">
      <div className="text-center mb-8">
        <div className="w-20 h-20 rounded-[24px] bg-slate-900 dark:bg-slate-800 flex items-center justify-center mx-auto mb-6 shadow-xl shadow-slate-200 dark:shadow-none">
      ...
      <Card>
        {!mode ? (
          <div className="space-y-3 p-2">
            <button onClick={() => setMode("create")} className="w-full flex items-center justify-between p-4 rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 hover:bg-white dark:hover:bg-slate-800 hover:border-slate-300 hover:shadow-md transition-all group">
              <div className="flex items-center gap-4 text-left">
                <div className="w-10 h-10 rounded-lg bg-white dark:bg-slate-950 flex items-center justify-center border border-slate-200 dark:border-slate-700 group-hover:bg-slate-900 group-hover:dark:bg-slate-100 group-hover:text-white group-hover:dark:text-slate-900 transition-colors">
                  <UserPlus size={20} />
                </div>
                <div>
            ...
            <button onClick={() => setMode("join")} className="w-full flex items-center justify-between p-4 rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 hover:bg-white dark:hover:bg-slate-800 hover:border-slate-300 hover:shadow-md transition-all group">
              <div className="flex items-center gap-4 text-left">
                <div className="w-10 h-10 rounded-lg bg-white dark:bg-slate-950 flex items-center justify-center border border-slate-200 dark:border-slate-700 group-hover:bg-slate-900 group-hover:dark:bg-slate-100 group-hover:text-white group-hover:dark:text-slate-900 transition-colors">
                  <Shield size={20} />
                </div>
          ...
          <Card className="dark:bg-[#0d1426] dark:border-slate-800">
            <div className="p-1">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 rounded-xl bg-slate-900 dark:bg-slate-800 flex items-center justify-center shrink-0 shadow-lg shadow-slate-200 dark:shadow-none">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center text-sm">
                  <span className="text-slate-500 dark:text-slate-400 font-medium">Miembros</span>
                  <span className="font-bold text-slate-900 dark:text-white">{group.members.length} / 6</span>
                </div>
                <div className="h-1.5 w-full bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
                  <div 
                    className="h-full bg-slate-900 dark:bg-slate-400 transition-all duration-500" 
                ...
                <div className="mt-8 pt-6 border-t border-slate-100 dark:border-slate-800">
                  ...
                  <div className="bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-2xl p-4 text-center">
                    ...
                    <button 
                      ...
                      className="flex items-center justify-center gap-2 w-full py-2 bg-white dark:bg-[#0a0f1e] border border-slate-200 dark:border-slate-700 rounded-xl text-slate-400 hover:text-slate-900 dark:hover:text-white hover:border-slate-400 transition-all text-[10px] font-bold uppercase tracking-tight"
                    >
                  ...
                  <div className="mt-4 flex gap-2 items-start p-3 bg-blue-50/50 dark:bg-blue-500/10 rounded-xl border border-blue-100 dark:border-blue-500/20">
                    ...
                    <tr key={m.id} className="group hover:bg-slate-50/50 dark:hover:bg-white/[0.02] transition-colors">
                      <td className="py-4 px-2">
                        <div className="flex items-center gap-3">
                          <div className="w-9 h-9 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center font-bold text-slate-500 text-xs border border-white dark:border-slate-700 shadow-sm shrink-0">
                            {m.fullName.charAt(0)}
                          </div>
                          <div className="min-w-0">
                            <p className="text-sm font-bold text-slate-900 dark:text-slate-100 leading-none mb-1 truncate">{m.fullName}</p>
