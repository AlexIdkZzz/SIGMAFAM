...
export default function Dashboard() {
  ...
  return (
    ...
    >
      {latestActive ? (
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/50 rounded-2xl p-4 flex items-center justify-between gap-3 transition-colors">
          <div>
            <div className="font-extrabold text-red-700 dark:text-red-400 flex items-center gap-2">
        ...
        <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800/50 rounded-2xl p-4 transition-colors">
          <div className="font-extrabold text-emerald-700 dark:text-emerald-400">Sin alertas activas</div>
          <div className="text-sm text-emerald-600 dark:text-emerald-300">Todo tranquilo por ahora ✅</div>
        </div>
      )}
