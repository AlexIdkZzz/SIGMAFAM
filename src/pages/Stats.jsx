    ...
    return (
      <PageShell title="Dashboard Operativo">
        <div className="flex flex-col items-center justify-center py-32 gap-4">
          <div className="w-16 h-16 rounded-2xl bg-red-500/10 dark:bg-red-500/15 flex items-center justify-center">
          ...
          <button
            ...
            className="mt-2 px-6 py-2.5 rounded-xl bg-slate-900 dark:bg-white text-white dark:text-slate-900 text-[10px] font-black uppercase tracking-widest hover:opacity-90 transition-all"
          >
            Reintentar
          </button>
        </div>
